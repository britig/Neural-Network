...
def test(input_value,output_value,weight_hidden1,bias_hidden1,weight_hidden2,bias_hidden2,weight_output,bias_output): 
    ...
    hiddenlayer1_output = sigmoid(hidden_layer_input)
    hiddenlayer2_input = hiddenlayer1_output.dot(weight_hidden2)+bias_hidden2
    hiddenlayer2_output = sigmoid(hiddenlayer2_input)
...
if __name__ == "__main__":
    ...
    output_neurons = 2 #Two classes to predict
    ...
    for i in range(epoch):
        ...
        hiddenlayer1_output = sigmoid(hiddenlayer1_input)
        ...
        #Softmax activation
        final_output = softmax(otputlayer_input)
        
        #To check the test train error after every iteration
        ...
        '''Backpropagation'''
        delta_output = final_output
        #Output Layer error
        delta_output[range(1), out] -= 1
        
        slope_hidden_layer1 = derivative_sigmoid(hiddenlayer1_output)
        slope_hidden_layer2 = derivative_sigmoid(hiddenlayer2_output)
